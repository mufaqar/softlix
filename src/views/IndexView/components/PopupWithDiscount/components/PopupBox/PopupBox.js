  ...
  return (
    <Dialog
      ...
      sx={{ width: '100%',
        '& .MuiPaper-root': {
          borderRadius: 4,
          width: '100%',  maxWidth: '420px', width:'100%', borderRadius: '0.4375rem', margin:'0', paddingTop:'0px'
        },
      }}
    >
      <Box
        sx={{
          ...
          paddingY: { xs: 0, sm: 0 },
          paddingX: { xs: 0, sm: 0 },
          width: '100%',  maxWidth: '420px', width:'100%',
          margin:'0', padding:'0'
        }}
      >
        <Box  sx={{width: '100%', margin:'0', padding:'0'  }}>
         <Box md="4"  sx={{width: '100%', margin:'0', padding:'0', border:'none!important'  }}>
          {/*<Button
            block
            Boxor="default"
            type="button"
          ...
          <Box>
            <Box className=" Box-body p-0">
              ...
              <Typography
          align={'center'}
          sx={{ textDecoration: 'underline', cursor: 'pointer', padding: '10px',  position: 'absolute', right: '5px', zIndex: '99' }}
          onClick={onClose}
        >
         <svg sx={{ textDecoration: 'underline', cursor: 'pointer' }} xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 512 512">
          <g><g xmlns="http://www.w3.org/2000/svg"><path d="m25 512a25 25 0 0 1 -17.68-42.68l462-462a25 25 0 0 1 35.36 35.36l-462 462a24.93 24.93 0 0 1 -17.68 7.32z" fill="#2c4bff" data-original="#000000" class=""></path><path d="m487 512a24.93 24.93 0 0 1 -17.68-7.32l-462-462a25 25 0 0 1 35.36-35.36l462 462a25 25 0 0 1 -17.68 42.68z" fill="#2c4bff" data-original="#000000" class=""></path></g></g>
          </svg>
        </Typography>
                <Box className=" bg-white pb-5"  sx={{padding: '1.25rem 1.5rem', border:'none!important' }}>
                  <Box className=" text-muted text-center mb-3" sx={{ fontWeight: '400', color: '#8898aa', textAlign:'center',  border:'none!important'}} >
                    <Box className="text-center text-muted mb-4" sx={{ fontWeight: '400', color: '#8898aa', textAlign:'center',  border:'none!important' }}>
                    <Box sx={{color:'#2c4bff'}}>Request A Call Back or Call Directly on <Button
          variant="text"
          color="primary"
          component="a"
          target="blank"
          ...
          size="medium"
          sx={{padding:0}}
        >+919818565561 </Button> </Box>
                  </Box>
                    <small>We are always available to Answer your query</small> 
                  </Box>
                  {/*
                ...
                <Box className=" px-lg-5 py-lg-5" sx={{ paddingTop: '1rem !important', padding: '1rem !important', backgroundColor: '#f7fafc !important', borderTop: '1px solid rgba(0,0,0,0.05)' }}>
...
<form onSubmit={formik.handleSubmit}>
        ...
        >
          ...
          <Grid
            ...
            flexDirection={'column'}
          >
            <Button size={'large'} variant={'contained'} type={'submit'} sx={{ backgroundColor:'#4a37a5!important' }}>
             {btnLabel}
            </Button>
            <Typography
              variant={'subtitle2'}
