...
const WithOptionTogglerButton = () => {
  ...
  return (
    ...
    justifyContent:'space-around',
                ...
                <Tab sx={{  fontSsize: '16px', fontWeight: '600' }} label="Website Design & Development" {...a11yProps(0)} />
                <Tab sx={{  fontSsize: '16px', fontWeight: '600' }} label="App development" {...a11yProps(1)} />
