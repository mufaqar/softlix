        ...
        <>
            ...
            <section className="bg-white">
                <div className="flex flex-col lg:flex-row lg:items-center">
                    <div className="w-full lg:w-1/2">
                        <div className="py-20 px-6">
                            <h1 className="text-2xl font-bold tracking-wide text-gray-800 lg:text-3xl">
                                Launch your eCommerce Business & Sell Products Worldwide with the #1<br /> Easy-to-Use eCommerce App and Website (Complete Solution)
                            </h1>
                            <p className='leading-relaxed text-lg mt-3'>Perfect for beginners and seasoned eCommerce giants</p>

                            <div className='space-x-3 mt-5'>
                                <Link href="#">
                                    <a className="inline-block rounded-lg bg-indigo-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-indigo-600 hover:bg-indigo-700 hover:ring-indigo-700"> Get started
                                        <span className="text-indigo-200 ml-3" aria-hidden="true">&rarr;</span></a>
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="w-full lg:w-1/2 _banner">
                        <img className="object-cover" src="https://images.unsplash.com/photo-1543269664-7eef42226a21?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="glasses photo" />
                    </div>
                </div>
            </section >
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-20">
                        <h2 className="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">E-Commerce</h2>
                        <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-900">Perfect for beginners and seasoned eCommerce giants</h1>
                    </div>
                        ...
                        <div className="p-4 md:w-1/4">
                            <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                                <div className="flex items-center mb-3">
                                    ...
                                    <h2 className="text-gray-900 text-lg title-font font-medium">Maximize Your Sales & Order Value</h2>
                                </div>
                                <div className="flex-grow">
                                    <p className="leading-relaxed text-base">with a shop that attracts customers & floods them with buyer confidence</p>
                        ...
                        <div className="p-4 md:w-1/4">
                            <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                                <div className="flex items-center mb-3">
                                    ...
                                    <h2 className="text-gray-900 text-lg title-font font-medium">Boost Your Bottom Line</h2>
                                </div>
                                <div className="flex-grow">
                                    <p className="leading-relaxed text-base">with automated email flows for up-sells, cart reminders, & more</p>
                        ...
                        <div className="p-4 md:w-1/4">
                            <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                                <div className="flex items-center mb-3">
                                    ...
                                    <h2 className="text-gray-900 text-lg title-font font-medium">Sell All Over the Globe</h2>
                                </div>
                                <div className="flex-grow">
                                    <p className="leading-relaxed text-base">by taking your products online within hours of using our app (less work, more sales!)</p>
                        ...
                        <div className="p-4 md:w-1/4">
                            <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                                <div className="flex items-center mb-3">
                                    ...
                                    <h2 className="text-gray-900 text-lg title-font font-medium">Great Looking UI/ UX</h2>
                                </div>
                                <div className="flex-grow">
                                    <p className="leading-relaxed text-base">Design Which will surely attract the Customers</p>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
                    <div className="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
                        <h2 className="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">Start selling today</h2>
                        <h1 className="md:text-3xl text-2xl font-medium title-font text-gray-900">By completing our short sign-up form</h1>
                    </div>
                    <div className="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
                        <Link href="#">
                            <a className="inline-block rounded-lg bg-indigo-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-indigo-600 hover:bg-indigo-700 hover:ring-indigo-700"> Sign Up Today
                                <span className="text-indigo-200 ml-3" aria-hidden="true">&rarr;</span></a>
                        </Link>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center">
                    <div className="w-full lg:w-1/2">
                        <div className="py-20 px-6">
                            ...
                            <p className='leading-relaxed text-lg mt-3'>The key to building a profitable eCommerce business is to make it watertight. Even the smallest of issues can cause customers to run a mile and your sales to plummet.</p>
                            <p className='leading-relaxed text-lg mt-3'>The SOFTLIX™ app makes it simple & effortless to launch your eCommerce business, attract waves of buyers, & sell your products online with little to no work.</p>
                ...
                <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                    ...
                    <div className="grid gap-8 row-gap-0 lg:grid-cols-4">
                        <div className="relative text-center">
                            ...
                            <h6 className="mb-2 text-xl font-extrabold">Ready-to-Go Websites that Attract Customers</h6>
                            <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
                                We'll design, build, & develop a stunning website to launch your business & start selling worldwide
                            </p>
                        ...
                        <div className="relative text-center">
                            ...
                            <h6 className="mb-2 text-xl font-extrabold">Powerful Marketing at your Fingertips
                            </h6>
                            <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
                                Building & running a high-converting marketing campaign is simple with SOFTLIX's built-in advertising toolbox
                            </p>
                            <div className="top-0 right-0 flex items-center justify-center h-24 lg:-mr-8 lg:absolute">
                                <svg
                                    className="w-8 text-gray-700 transform rotate-90 lg:rotate-0"
                        ...
                        <div className="relative text-center">
                            ...
                            <h6 className="mb-2 text-xl font-extrabold">Payment Systems for Everyone & Anyone</h6>
                            <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
                                Open the floodgates to worldwide customers with multiple payment gateways you and your customers can trust
                            </p>
                            <div className="top-0 right-0 flex items-center justify-center h-24 lg:-mr-8 lg:absolute">
                                <svg
                                    className="w-8 text-gray-700 transform rotate-90 lg:rotate-0"
                        ...
                        <div className="relative text-center">
                            ...
                            <h6 className="mb-2 text-xl font-extrabold">Shipping Made Easy</h6>
                            <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
                                Shipping your products is a breeze with tap-and-go solutions for delivering across the globe
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-center ">
                    <div className="flex flex-col justify-center  my-10 w-[90%] space-y-28 lg:space-y-24 max-w-7xl">
                        ...
                        <div className="flex flex-col justify-center items-center lg:flex-row space-y-28 lg:space-y-0  lg:space-x-10">
                            <div
                                className="bg-slate-200 shadow-lg flex flex-col justify-center items-center py-4 h-56 md:w-[80%] lg:w-fit">
                                <div className="-mt-20 ">
                                    <img src="https://source.unsplash.com/150x150/?man" className="rounded-full " alt="" />
                                </div>
                                <p className="text-center text-sm p-5">Tailblockss provides best Tailwind CSS Components and Blocks to
                                ...
                                <div className="flex flex-col lg:flex-row justify-center text-center lg:space-x-3">
                                    <h1 className="text-orange-500 text-lg font-semibold">Antonio Starc</h1>
                            ...
                            <div
                                className="bg-slate-200 shadow-lg flex flex-col justify-center items-center py-4 h-56 md:w-[80%] lg:w-fit">
                                <div className="-mt-20 ">
                                    <img src="https://source.unsplash.com/150x150/?girl" className="rounded-full " alt="" />
                                </div>
                                <p className="text-center text-sm p-5">Tailblockss provides best Tailwind CSS Components and Blocks to
                                    create an unique websites within minutes.</p>
                                <div className="flex flex-col lg:flex-row justify-center text-center lg:space-x-3">
                                    <h1 className="text-orange-500 text-lg font-semibold">Jessica Starc</h1>
                                    <p className="text-black text-sm lg:mt-[5px]">Co-Founder at xyz</p>
                                </div>
                            </div>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
                    <h2 className="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">Trusted & Used by Big Name Brands</h2>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center">
                    <div className="w-full lg:w-1/2">
                        <div className="py-20 md:px-16 px-6">
                            ...
                            <p className='leading-relaxed text-lg mt-3'>The intuitive dashboard removes the stress & confusion of launching an eCommerce business - Making it perfect for beginners and professionals.</p>
                            <p className='leading-relaxed text-lg mt-3'>After we build your web and App, you can start optimizing your business, marketing your goods, & selling products to thousands of customers all over the world</p>
                        </div>
                    ...
                    <div className="grid max-w-md gap-10 row-gap-5 sm:row-gap-10 lg:max-w-screen-md lg:grid-cols-2 sm:mx-auto">
                        <div className="flex flex-col justify-between p-5 bg-white border rounded shadow-sm">
                            <div className="mb-6">
                                ...
                                <div>
                                    <p className="mb-2 font-bold tracking-wide">Launch your store & sell online</p>
                                    <ul className="space-y-2">
                                        <li className="flex items-center">
                                            <div className="mr-2">
                                                <svg className="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" strokeLinecap="round" strokeWidth="2">
                                            ...
                                            <p className="font-medium text-gray-800">Perfect for a Beginner or Dedicated Brand</p>
                                        </li>
                                        <li className="flex items-center">
                                            <div className="mr-2">
                                                <svg className="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" strokeLinecap="round" strokeWidth="2">
                                            ...
                                            <p className="font-medium text-gray-800">1x Stunning Website</p>
                                        </li>
                                        <li className="flex items-center">
                                            <div className="mr-2">
                                                <svg className="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" strokeLinecap="round" strokeWidth="2">
                                            ...
                                            <p className="font-medium text-gray-800">Android and IOS App to Supercharge & Scale your Business</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div>
                                <a href="/" className="inline-flex items-center justify-center w-full h-12 px-6 mb-4 font-medium tracking-wide text-white transition duration-200 bg-gray-800 rounded shadow-md hover:bg-gray-900 focus:shadow-outline focus:outline-none">
                                    Get Started
                                </a>
                        ...
                        <div className="flex flex-col justify-between p-5 bg-white border rounded shadow-sm">
                            <div className="mb-6">
                                <div className="flex items-center justify-between pb-6 mb-6 border-b">
                                    ...
                                    <div className="flex items-center justify-center w-24 h-24 rounded-full bg-indigo-50">
                                        <svg className="w-10 h-10 text-deep-purple-accent-400" viewBox="0 0 24 24" strokeLinecap="round" strokeWidth="2">
                                ...
                                <div>
                                    <p className="mb-2 font-bold tracking-wide">Build multiple high-profit online stores</p>
                                    <ul className="space-y-2">
                                        <li className="flex items-center">
                                            <div className="mr-2">
                                                <svg className="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" strokeLinecap="round" strokeWidth="2">
                                            ...
                                            <p className="font-medium text-gray-800">Ideal for Seasoned Professionals or Owners of Multiple Businesses</p>
                                        </li>
                                        <li className="flex items-center">
                                            <div className="mr-2">
                                                <svg className="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" strokeLinecap="round" strokeWidth="2">
                                            ...
                                            <p className="font-medium text-gray-800">Web Version of App for Each of Your Businesses</p>
                                        </li>
                                        <li className="flex items-center">
                                            <div className="mr-2">
                                                <svg className="w-4 h-4 text-deep-purple-accent-400" viewBox="0 0 24 24" strokeLinecap="round" strokeWidth="2">
                                            ...
                                            <p className="font-medium text-gray-800">SOFTLIX™ App to Supercharge & Scale your Business</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Build multiple high-profit online stores | Only RS. 59,999 or USD 750
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="relative bg-[#c7def3]">
                ...
                <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                    <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
                        ...
                        We Use Well Know Platform Shopify, WooCommerce, Opencart, Magento, PHP, or Python, the SOFTLIX™ app makes it simple, quick, & more effective - Helping you to launch your online business and sell more products in less time (and with less effort!)
                        </p>
                        <p className="mb-6 text-base md:text-lg">
                        Sign up today, pick a package that suits you, and start selling online within hours of starting
                        </p>
                    </div>
                </div>
            </div>
            ...
            <section className="py-20 lg:py-[120px]">
                <div className="container mx-auto">
                    <div
                        className="bg-blue-800 relative z-10 overflow-hidden rounded py-12 px-8 md:p-[70px]"
                    >
                        <div className="-mx-4 flex flex-wrap items-center">
                            <div className="w-full px-4 lg:w-2/3">
                                ...
                                <span className="mt-2 text-sm text-white">
                                    If your business isn't online, you're missing out on a world of customers (literally). Start today, and by tomorrow, Maybe you'll be selling thousands of units to hundreds of customers all over the globe!
                                </span>
